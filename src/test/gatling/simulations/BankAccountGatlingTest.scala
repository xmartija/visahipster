...
class BankAccountGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the BankAccount entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "nameOnCard":"SAMPLE_TEXT", "address":"SAMPLE_TEXT", "accountNumber":null, "isDefault":null, "senderCity":"SAMPLE_TEXT", "senderCountryCode":"SAMPLE_TEXT", "senderStateCode":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
